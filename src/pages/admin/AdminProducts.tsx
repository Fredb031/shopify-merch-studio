            ...
            return (
              ...
              >
                <div className="aspect-square bg-zinc-100 relative">
                  {p.firstImage && (
                    <img src={p.firstImage} alt="" width={400} height={400} className="w-full h-full object-cover" loading="lazy" decoding="async" onError={e => { (e.currentTarget as HTMLImageElement).style.visibility = 'hidden'; }} />
                  )}
