            ...
            <AnimatePresence mode="wait">
              ...
              {store.step === 1 && (
                <motion.div key="s1" initial={{ opacity:0, x:16 }} animate={{ opacity:1, x:0 }} exit={{ opacity:0, x:-16 }} className="space-y-4">
                  ...
                  {/* Section 16.1 starter template gallery removed — operators
                      asked us to drop themed-placement presets so every
                      customization starts from a blank canvas. The user
                      uploads their logo and positions it themselves; the
                      "Mes modèles" panel below still lets them save and
                      reload their OWN configurations. */}
