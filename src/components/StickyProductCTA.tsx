    ...
    >
      <div className="flex items-center gap-3 px-3 py-2">
        ...
        <button
          ...
          className="shrink-0 px-4 py-2.5 gradient-navy-dark text-primary-foreground rounded-xl text-[13px] font-extrabold cursor-pointer flex items-center gap-1.5 focus:outline-none focus-visible:ring-4 focus-visible:ring-[#E8A838]/60 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
