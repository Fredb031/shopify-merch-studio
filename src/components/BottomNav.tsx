...
export function BottomNav() {
  ...
  const items = useMemo(() => ([
    ...
    // The "Créer" tab was removed — it duplicated the per-product
    // Personnaliser CTA on /products cards and PDPs (which is the
    // canonical entry to the customizer). Three tabs only now.
